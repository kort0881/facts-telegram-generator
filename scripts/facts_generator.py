...
2) Далее блок «Факт» — 1–3 коротких предложения. Не пиши слово «Факт:», просто текст.
3) Пустая строка.
...
7) Отдельной строкой в конце — вопрос читателю и 2–4 хэштега по теме.

ТРЕБОВАНИЯ:
- Пиши по-русски, живым, современным, но без сленга, который быстро устареет.
...
- Не используй HTML-теги (<b>, <i> и т.п.), только обычный текст.
- Текст должен быть готов к прямой отправке в Telegram, без дополнительного форматирования.
